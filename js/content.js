var words = {
    other: {"en": ["Breast Health","Click to start","Start Testing","Settings","Version 1.0","Notifications","Sounds","Test","Add Note","Date","Address","Room","Doctor","Remind","Comment", "Visit your doctor in", "Note", "Listen to the question", "Take the test again?", "Save?", "All inputs required", "Space for your notes", "This time period is already in use.", "Chosen date has already passed", "Reset the results?", "Yes", "No"],
            "ru": ["Здоровая Грудь","Нажмите, чтобы начать тест","Пройти тест","Настройки","Версия 1.0","Уведомления","Звуки","Тест","Добавить заметку","Дата","Адрес","Кабинет","Врач","Напомнить за..","Комментарий", "Визит к врачу через", "Заметка", "Прослушать вопрос", "Пройти заново?", "Сохранить?", "Заполните все поля", "Для Ваших заметок", "Уже существует запись на заданное время", "Выбранная вами дата уже прошла.", "Сбросить тест?", "Да", "Нет"]
    },
    swiperwords:{
